...
PHPStan / Psalm / PhpStorm stubs for `ext-protobuf` v4.29.6.

## Installation

```
composer require --dev krsque/php-ext-protobuf-stubs:~29.6.0
```

## Version convention

Stubs versions map to `ext-protobuf` with the major version dropped: ext-protobuf `v4.29.6` → stubs `29.6.*`.
