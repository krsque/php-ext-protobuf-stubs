...
PHPStan / Psalm / PhpStorm stubs for `ext-protobuf` v4.27.2.

## Installation

```
composer require --dev krsque/php-ext-protobuf-stubs:~27.2.0
```

## Version convention

Stubs versions map to `ext-protobuf` with the major version dropped: ext-protobuf `v4.27.2` → stubs `27.2.*`.
