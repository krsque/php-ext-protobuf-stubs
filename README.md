...
PHPStan / Psalm / PhpStorm stubs for `ext-protobuf` v4.29.3.

## Installation

```
composer require --dev krsque/php-ext-protobuf-stubs:~29.3.0
```

## Version convention

Stubs versions map to `ext-protobuf` with the major version dropped: ext-protobuf `v4.29.3` → stubs `29.3.*`.
