...
PHPStan / Psalm / PhpStorm stubs for `ext-protobuf` v4.29.5.

## Installation

```
composer require --dev krsque/php-ext-protobuf-stubs:~29.5.0
```

## Version convention

Stubs versions map to `ext-protobuf` with the major version dropped: ext-protobuf `v4.29.5` → stubs `29.5.*`.
