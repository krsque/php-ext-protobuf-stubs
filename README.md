...
PHPStan / Psalm / PhpStorm stubs for `ext-protobuf` v4.28.0.

## Installation

```
composer require --dev krsque/php-ext-protobuf-stubs:~28.0.0
```

## Version convention

Stubs versions map to `ext-protobuf` with the major version dropped: ext-protobuf `v4.28.0` → stubs `28.0.*`.
