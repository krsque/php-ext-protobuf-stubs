...
PHPStan / Psalm / PhpStorm stubs for `ext-protobuf` v4.29.4.

## Installation

```
composer require --dev krsque/php-ext-protobuf-stubs:~29.4.0
```

## Version convention

Stubs versions map to `ext-protobuf` with the major version dropped: ext-protobuf `v4.29.4` → stubs `29.4.*`.
